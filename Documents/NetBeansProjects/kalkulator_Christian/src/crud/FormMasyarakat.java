...
public class FormMasyarakat extends javax.swing.JFrame {
    ...
    public void tampilDatabase() {
        Object[] baris = {"NIK", "Nama", "Username", "Password", "Telpon"};
        tabMode = new DefaultTableModel(null, baris);
        tabel_masyarakat.setModel(tabMode);
        try {
            hasil = cr.tampilData();
            while (hasil.next()) {
                m.setNik(hasil.getString("nik"));
                m.setNama(hasil.getString("nama"));
                m.setUsername(hasil.getString("username"));
                m.setPassword(hasil.getString("password"));
                m.setTelp(hasil.getString("telp"));
                String[] data = {m.getNik(), m.getNama(), m.getUsername(), m.getPassword(), m.getTelp()};
                tabMode.addRow(data);
    ...
    private void initComponents() {
        ...
        tabel_masyarakat = new javax.swing.JTable();
        ...
        jLabel2.setMinimumSize(new java.awt.Dimension(58, 100));
        ...
        tabel_masyarakat.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tabel_masyarakat.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tabel_masyarakatMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tabel_masyarakat);
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txt_nik, javax.swing.GroupLayout.PREFERRED_SIZE, 230, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txt_password, javax.swing.GroupLayout.PREFERRED_SIZE, 230, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txt_telp, javax.swing.GroupLayout.PREFERRED_SIZE, 230, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addContainerGap()
    ...
    private void buttonSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSimpanActionPerformed
        // TODO add your handling code here:
        if (txt_nik.getText().trim().equals("")) {
            ...
            JOptionPane.showMessageDialog(null, "Maaf, Telp belum diisi !");
            txt_telp.requestFocus();
        } else {
            try {
                cr.simpanData(txt_nik.getText(), txt_nama.getText(), txt_username.getText(), txt_password.getText(), txt_telp.getText());
    ...
    private void buttonUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonUbahActionPerformed
        ...
        if (txt_nik.getText().trim().equals("")) {
            ...
            try {
                m.setNik(txt_nik.getText());
                m.setNama(txt_nama.getText());
                m.setTelp(txt_telp.getText());
                cr.ubahData(m.getNik(), m.getNama(), m.getTelp());
    ...
    private void tabel_masyarakatMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabel_masyarakatMouseClicked
        // TODO add your handling code here:
        try {
            int row = tabel_masyarakat.rowAtPoint(evt.getPoint());
            String nik = tabel_masyarakat.getValueAt(row, 0).toString();
            String nama = tabel_masyarakat.getValueAt(row, 1).toString();
            String username = tabel_masyarakat.getValueAt(row, 2).toString();
            String password = tabel_masyarakat.getValueAt(row, 3).toString();
            String telp = tabel_masyarakat.getValueAt(row, 4).toString();
...
//            txt_password.setEnabled(false);
            ...
            txt_nik.setText(String.valueOf(nik));
            txt_nama.setText(String.valueOf(nama));
            txt_username.setText(String.valueOf(username));
            txt_password.setText(String.valueOf(password));
            txt_telp.setText(String.valueOf(telp));
        } catch (Exception e) {

        }
    }//GEN-LAST:event_tabel_masyarakatMouseClicked
    ...
    private javax.swing.JTable tabel_masyarakat;
